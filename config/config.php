...
if(!defined('ROOT_PATH')) {
	...
	return array(
		...
		'memcache' => file_exists(CONFIG_PATH.'/mem.cfg.php') ? require_once(CONFIG_PATH.'/mem.cfg.php') : '',
		'redis' => file_exists(CONFIG_PATH.'/redis.cfg.php') ? require_once(CONFIG_PATH.'/redis.cfg.php') : '',
